db.movies.aggregate({$match:{languages:"English"}},{$project:{title:1,imdbRating:"$imbd.rating"}})
...
db.movies.aggregate({$match:{"type":"movie"}},{$group:{_id:"year",numberOfFilms:{$sum:1},avgRating:{$avg:"imdb.rating"}}},
    {$project:{_id:0,year:"$_id",numberOfFilms:1,avgRating:1}}
)
